# Claude Code Einstein Quiz Launcher
# Automatically starts Claude Code and provides Einstein Quiz
...
Write-Host "Einstein Quiz Launcher Starting..." -ForegroundColor Green
